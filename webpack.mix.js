...
mix.less('resources/less/adminto/adminto.less', 'public/css/adminto.css')
    ...
    .copy('resources/images/adminto/users/user-no-image.png', 'public/images/users/user-no-image.png')
    ...
    .copy('resources/js/adminto/plugins/bootstrap-sweetalert/', 'public/plugins', false)
